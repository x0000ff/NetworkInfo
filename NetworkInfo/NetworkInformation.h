...
OBJC_EXTERN const int NetworkInformationInterfaceTypeIPv4;
OBJC_EXTERN const int NetworkInformationInterfaceTypeMAC;
OBJC_EXTERN const NSString *NetworkInformationInterfaceAddressKey;
